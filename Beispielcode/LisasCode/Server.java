  ...
  public void run() {
    while (true) {
      try {
        // Output
        System.out.println(
          "Hi! I am the server with the port " + server.getLocalPort()
        );
        ...
        System.out.println(
          "RemoteSocket address:  " + client.getRemoteSocketAddress() + "\n"
        );

        output.writeUTF(
          "Hi! Here you can perform a very simple caesar encryption. Enter your text here: " +
          "\n"
        );
