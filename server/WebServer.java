...
public class WebServer {
  ...
  public static void sendOutput(Socket client) throws IOException {
    ...
    // clientOutput.write("\r\n".getBytes());
    // clientOutput.write(testHTML.getBytes());
    // clientOutput.write("\r\n\r\n".getBytes());
    // clientOutput.flush();
    // client.close();
  }
